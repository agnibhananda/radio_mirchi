                        ...
                        <div className="mb-4">
                          <div className="flex items-center justify-center gap-3">
                            ...
                            <button
                              ...
                              className="w-8 h-8 rounded-full bg-yellow-200 hover:bg-yellow-300 flex items-center justify-center text-yellow-700 transition-all duration-200 hover:scale-110"
                              title="Leaderboard"
                            >
                              🏆
                            </button>
